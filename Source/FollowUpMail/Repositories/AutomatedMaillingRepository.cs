...
namespace FollowUpMail.Repositories {
  public class AutomatedMaillingRepository {
    ...
    /// <param name="dateTime">The threshold for the query. Only orders qhich where finalized before this date will be considered.</param>
    /// <returns></returns>
    public IEnumerable<Guid> GetFollowUpOrdersOlderThenDateTime( long storeId, DateTime dateTime ) {
      ...
      sql += "AND OPShipped.Value < @1 AND OPFollow.Value = ''";
